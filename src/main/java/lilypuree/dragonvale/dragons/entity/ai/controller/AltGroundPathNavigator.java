...
//import net.minecraft.pathfinding.TempPathNavigator;
...
//
//public class AltGroundPathNavigator extends TempPathNavigator {
//    private boolean shouldAvoidSun;
//
//    public AltGroundPathNavigator(MobEntity entity, World world) {
//        super(entity, world);
//    }
//
...
//            for(tempPos = pos.down(); tempPos.getY() > 0 && this.world.getBlockState(tempPos).isAir(); tempPos = tempPos.down()) {
//            }
//
//            if (tempPos.getY() > 0) {
//                return super.getPathToPos(tempPos.up(), p_179680_2_);
//            }
//
//            while(tempPos.getY() < this.world.getHeight() && this.world.getBlockState(tempPos).isAir()) {
//                tempPos = tempPos.up();
//            }
//
//            pos = tempPos;
...
//        } else {
//            for(tempPos = pos.up(); tempPos.getY() < this.world.getHeight() && this.world.getBlockState(tempPos).getMaterial().isSolid(); tempPos = tempPos.up()) {
//            }
//
//            return super.getPathToPos(tempPos, p_179680_2_);
//        }
//    }
//
